...
class ParentWindow(Frame):
    def __init__ (self, master):
        ...
        self.txtFName = Entry(self.master,tex=self.varFName, font=("Helvetica", 16), fg='black', bg='lightblue')
        self.txtFName.grid(row=0, column=1, padx=(30,0), pady=(30,0))
        
        self.txtLName = Entry(self.master,tex=self.varLName, font=("Helvetica", 16), fg='black', bg='lightblue')
